...
def single_det_energies(phfrun_out,ndet):
  ...
  hmmt = read_phfrun_det(mm,'hmmt matrix',ndet,max_ndet=1024*64) 
  ovmt = read_phfrun_det(mm,'ovmt matrix',ndet,max_ndet=1024*64) 
...
if __name__ == '__main__':
  ...
  phf_outfile = os.path.join(det_dir,'slurm-995137.out')  # phf output file, needed to read hmmt & ovmt

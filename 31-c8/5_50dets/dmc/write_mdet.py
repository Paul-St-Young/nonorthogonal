...
def sposet_builder(h5_file,nstate):
  sponode = etree.Element('sposet_builder',{'type':'bspline','href':h5_file,'tilematrix':'1 0 0 0 1 0 0 0 1','twistnum':'0','source':'ion0','version':'0.10','meshfactor':'1.0','fftgrid':'51 51 51','precision':'double'})

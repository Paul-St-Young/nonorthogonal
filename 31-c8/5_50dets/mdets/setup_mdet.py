...
def setup_ci_mdet(dir_name,ci_coeff,wf_h5_fname,nfill
  ...
  setup_folder(dir_name,main_fname,wf_fname,wf_h5_fname,pseudo_file,'dmc.xml',jas_file=jas_file)
...
def main():
  from write_mdet import read_fortran_array
  ...
  # phfmol coefficients are messed up
